...
const caseStudyData: Record<string, CaseStudy> = {
  ...
  "maranatha-pediatrics": {
    ...
    approach: [
      ...
      "Community Engagement & Web Support: an active publishing schedule with a clear call to action on every asset, turning engagement into clinic website visits and patient enquiries."
    ],
